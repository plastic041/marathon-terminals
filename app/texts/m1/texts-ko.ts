export const texts = {
  introLabel: "시작",
  finalScreenLabel: "끝",
  title: `그들이 하늘에서, 기다립니다.`,
  intro: `"주 추진기 연소 종료 확인. 미라타 왕복선, 궤도 기동을 시작해도 좋습니다."
...
당신의 뇌보다 몸이 먼저 반사적으로 움직여 통신 개방 스위치를 켠다. "식민지 정거장, 듀란달이 방금 착륙 통로를 감압했다. 마라톤, 들리나. 격납 통로에 문제가 생겼다. 듀란달이…" 통신 상태를 나타내는 전구의 불이 꺼진다. "광기 상태가 된 것 같다."
...
듀란달이 다시 웃는다. "운이 좋군요. 외계 가상 기생충들과 노느라 당신에게서는 잠시 시선을 돌릴 테니까요. 이곳에 도착하면 다시 얘기를 나누죠…" 눈을 크게 뜨고 입술을 비틀며 기괴하게 웃는 사악한 컴퓨터의 얼굴이 머릿속에 그려진다. 과거에 본 적이 있는 것만 같지만, 정확히 무엇인지는 떠올릴 수 없다.
